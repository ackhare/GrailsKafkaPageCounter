...
<body>
<a href="#list-recordTime" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-recordTime" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="pageLeft"
                              title="${message(code: 'recordTime.pageLeft.label', default: 'Page Left')}"/>

            <g:sortableColumn property="pageVisited"
                              title="${message(code: 'recordTime.pageVisited.label', default: 'Page Visited')}"/>
            <g:sortableColumn property="timeSpentOnPage"
                              title="${message(code: 'recordTime.timeSpentOnPage.label', default: 'Time Spent On Page')}"/>
            <g:sortableColumn property="currentUrl"
                              title="${message(code: 'recordTime.currentUrl.label', default: 'Current Url')}"/>

            <g:sortableColumn property="referrerUrl"
                              title="${message(code: 'recordTime.referrerUrl.label', default: 'Referrer Url')}"/>
